...
# Date: 3/28/16
#
# Assignment: A14: CaesarCipher
# Purpose: The class imports a file, encrypts the file, and exports the cipher to a new file
#
# Acknowledgements: The original code was drafted by Dr. Scott Heggen
#                   Dr. and modified by Dr. Jan Pearce and modified again by Annie He
#
...
def main():
    ...
    cipher1.export_file(cipher_text1, "cipher_to_friend_1.txt")
    ...
    # Write the output to a file
    cipher2.export_file(cipher_text2, "cipher_to_friend_2.txt")
    ...
    testing.CaesarCipher_test_suite()
